    ...
    <section id="home" className="hero">
      ...
      <div className="hero-content">
        <div className="hero-tag">
          Ethan Lyle Cruz | Online Fitness Coach
        </div>
        ...
        <p>
          ...
          clients cut, bulk, maingain, and build strength with real plans that
          actually work and stick to it.
        </p>

        <div className="hero-ctas">
          {/* Opens the Coach E chatbot section */}
          <button
          ...
          {/* Opens the body-fat analyzer section */}
          <button
            className="btn-primary"
            onClick={() => scrollToSection("bodyfat")}
          >
            Analyze Body Fat
          </button>

          {/* Opens the client-results section */}
          <button
